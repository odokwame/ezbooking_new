        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-100 p-6 rounded-lg shadow">
              ...
              <p>
                Manage rooms, rates, availability and bookings with a powerful
                dashboard.
              </p>
            </div>
            <div className="bg-gray-100 p-6 rounded-lg shadow">
            ...
            <div className="bg-gray-100 p-6 rounded-lg shadow">
              ...
              <p>
                Schedule and manage shared spaces like halls, conference rooms
                and more.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div>
              ...
              <p>
                Keep your staff and clients informed with real-time updates.
              </p>
            </div>
            <div>
              <h4 className="text-xl font-semibold mb-2">
      ...
      <section id="contact" className="py-20 bg-blue-100">
        <div className="container mx-auto px-4 text-center">
          <h3 className="text-3xl font-bold mb-4">
            Ready to Elevate Your Booking Management?
          </h3>
          <p className="mb-6 text-gray-700">
            Contact us today to get started with EZBooking.
          </p>
          <a
            href="mailto:info@ezbooking.com"
